<?php 
    ...
    $objuser = new User(); //membuat objek user, agar function yang ada didalam klas user 
?>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small" id="btn_tambah" data-toggle="modal" data-target="#mediumModal">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="table-data-feature">
                                                            <button id="ubah"class="item" data-toggle="modal" data-placement="top" data-target="#mediumModal" 
